...
import '../LoginNew/LoginNew.css'


function LoginNewAdvisor() {
  ...
  <div className="col-md-6" style={Bgtwo}>
    ...
    onSubmit={onSubmit}>
        {
            ...
            <br/>
            <div style={{textAlign: 'center'}}><p> Don't have an account? <Link to='/signupadvisor'>Sign Up</Link> </p>  or 
            </div>
             </Form>
            }
        }
    ...
    <div className="bttn2new">
      <Link to='/signupadvisor'> Sign Up </Link>
    </div>
   </div>
    </div>
  </div>
...
export default LoginNewAdvisor